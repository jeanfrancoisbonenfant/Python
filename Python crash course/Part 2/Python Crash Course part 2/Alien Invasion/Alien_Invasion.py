...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        # Screen size setup and fullscreen mode.
    ...
    def _check_play_button(self,mouse_pos):
        ...
        if play_clicked | easy_clicked and not self.stats.game_active:
            self._start_game()

        elif medium_clicked and not self.stats.game_active:
            self._start_game()
            i = 1
            # Increse Difficulty time 5 for medimum level
            while i < 5:
            ...
            self._start_game()
            i = 1
            # Increase Difficulty time 10 for Hard level.
            while i < 10:
                self.settings.increase_speed()
                i += 1
    ...
    def _create_fleet(self):
        ...
        # Space beteen each alien is equal to one alien width.
        alien = Alien(self)
        alien_width, alien_height = alien.rect.size
        available_width = self.settings.screen_width - (2 - alien_width)
        number_aliens_x = (available_width // (2 * alien_width) - 1)
